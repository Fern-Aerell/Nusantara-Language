...
OperasiPerbandinganContext OperasiPerbandinganContext::generate(const std::vector<std::unique_ptr<ParserTree>>& children) {
  nstd::bisa_kosong<nstd::daftar<std::unique_ptr<Context>>> kumpulanOperasiPrePostContext;
  nstd::bisa_kosong<nstd::daftar<std::unique_ptr<Context>>> kumpulanOperatorPerbandinganContext;
...
nstd::konst<nstd::bisa_kosong<nstd::daftar<std::unique_ptr<Context>>>>& OperasiPerbandinganContext::getKumpulanOperasiPrePostContext() const {
    return this->kumpulanOperasiPrePostContext;
}

nstd::konst<nstd::bisa_kosong<nstd::daftar<std::unique_ptr<Context>>>>& OperasiPerbandinganContext::getKumpulanOperatorPerbandinganContext() const {
