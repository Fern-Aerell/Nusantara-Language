...
OperatorPrePostContext::OperatorPrePostContext(nstd::bisa_kosong<Token> simbolOp): simbolOp(std::move(simbolOp)) {}

OperatorPrePostContext OperatorPrePostContext::generate(const std::vector<std::unique_ptr<ParserTree>>& children) {
