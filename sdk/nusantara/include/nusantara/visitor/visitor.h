...
class Visitor {
 public:
  ...
  virtual T visitOperatorPenugasan(
      nstd::konst<OperatorPenugasanContext> &ctx) = 0;
  virtual T visitOperasiPenugasan(
      nstd::konst<OperasiPenugasanContext> &ctx) = 0;
  virtual T visitOperatorPenugasanPenjumlahan(
      nstd::konst<OperatorPenugasanPenjumlahanContext> &ctx) = 0;
  virtual T visitOperasiPenugasanPenjumlahan(
      nstd::konst<OperasiPenugasanPenjumlahanContext> &ctx) = 0;
  virtual T visitOperatorPenugasanPerkalian(
      nstd::konst<OperatorPenugasanPerkalianContext> &ctx) = 0;
  virtual T visitOperasiPenugasanPerkalian(
      nstd::konst<OperasiPenugasanPerkalianContext> &ctx) = 0;
  ...
  virtual T visitOperatorPerbandingan(
      nstd::konst<OperatorPerbandinganContext> &ctx) = 0;
  virtual T visitOperasiPerbandingan(
      nstd::konst<OperasiPerbandinganContext> &ctx) = 0;
  ...
  virtual T visitOperatorPenjumlahan(
      nstd::konst<OperatorPenjumlahanContext> &ctx) = 0;
  virtual T visitOperasiPenjumlahan(
      nstd::konst<OperasiPenjumlahanContext> &ctx) = 0;
  virtual T visitOperatorPerkalian(
      nstd::konst<OperatorPerkalianContext> &ctx) = 0;
  virtual T visitOperasiPerkalian(
      nstd::konst<OperasiPerkalianContext> &ctx) = 0;
